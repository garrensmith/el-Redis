...
should_reply_to_ping_message(_Info) ->
  {send, Response} = elredis_message_handler:process_message(<<"*1\r\n$4\r\nPING\r\n">>),
  [?_assertEqual(<<"+PONG\r\n">>, Response)].
...
should_set_key_and_respond_with_ok(_Info) ->
  {send, Response} = elredis_message_handler:process_message(<<"*3\r\n$3\r\nset\r\n$5\r\nmykey\r\n$5\r\nhello\r\n">>),
  [?_assertEqual(<<"+OK\r\n">>, Response)].

should_get_set_key_value(_Info) -> 
  elredis_message_handler:process_message(<<"*3\r\n$3\r\nset\r\n$5\r\nmykey\r\n$5\r\nhello\r\n">>),
  {send, Response} = elredis_message_handler:process_message(<<"*2\r\n$3\r\nget\r\n$5\r\nmykey\r\n">>),
  [?_assertEqual(<<"$5\r\nhello\r\n">>, Response)].

should_handle_message_that_are_larger(_Info) ->
  ...
  Response1 = elredis_message_handler:process_message(Message),
  Response2 = elredis_message_handler:process_message(Message),
